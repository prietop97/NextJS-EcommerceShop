		...
		<div>
			<div className="footerabout">
				<div className="footer-container">
					<h5 className="footer-title-primary">Navigation</h5>
				...
				<div className="footer-newsletter">
					<form>
						<h5 className="footer-title-primary">Newsletter</h5>
						<div className="newsletter-footer">
							...
							/>
							<Button size="xxs" text="SUBSCRIBE" handleSubmit={handleSubmit} />
						</div>
					</form>
					<div>
						<h5 className="footer-title-primary">Get Connected</h5>
						<div>
							<FacebookSVG color="black" />
							<InstagramSVG color="black" />
							<TwitterSVG color="black" />
						</div>
					</div>
				</div>
			</div>
			<div className="footernav">
				<div className="footer-record-container">
					<h5 className="record">©2020 Record</h5>
					<h6 className="powered-by">Powered by Pedro Prieto</h6>
				</div>

				<ul className="footer-trustbadge-container">
					<li>
						<svg
